  ...
  return (
    <div className="flex flex-col items-center gap-8 w-full">
      ...
      <div className="grid grid-cols-4 items-start gap-4 lg:gap-1.5 w-full px-4 lg:px-14">
        {capabilities?.map((cap, i) => (
          <div
            key={cap.id ?? i}
            className={cn(
              "flex flex-col lg:flex-row items-center max-lg:justify-center gap-2 border-b cursor-pointer flex-1 pb-2 lg:pb-6",
              i === activeCapIndex
                  ...
                  <TooltipTrigger asChild>
                    <Link
                      className={cn(
                        ...
                        "hover:bg-primary-500 hover:border-transparent",
                      )}
                      href={href ?? "#"}
                    >
      ...
      <div className="w-full px-4 lg:px-14">
        <div className="max-lg:hidden w-full py-8 px-12 rounded-[2rem] min-h-123 relative overflow-hidden">
          {/* Background image */}
