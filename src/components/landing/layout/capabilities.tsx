      ...
      <div className="w-full px-4 lg:px-14">
        <AnimatePresence mode="wait">
          ...
          >
                ...
                {activeCap?.services?.map(({ icon, title, href, id }, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <ChevronRight className="w-6 h-4 shrink-0 rtl:rotate-180" />
                    </Link>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="absolute bottom-0 inset-e-0 z-20 flex bg-white pt-5 ps-5 rounded-ss-[2rem]">
              {/* Top Inverted Corner */}
              <div className="absolute bottom-full inset-e-0 w-8 h-8 bg-transparent rounded-ee-[2rem]  shadow-[10px_10px_0_10px_white] rtl:shadow-[-10px_10px_0_10px_white] pointer-events-none" />

              {/* Left Inverted Corner */}
              <div className="absolute bottom-0 inset-e-full w-8 h-8 bg-transparent rounded-ee-[2rem]  shadow-[10px_10px_0_10px_white] rtl:shadow-[-10px_10px_0_10px_white] pointer-events-none" />
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.95 }}>
                ...
                >
                  ...
                  <div className="bg-white text-primary-500 rounded-full p-1.5 flex items-center justify-center">
                    <ArrowRight className="w-5 h-5 shrink-0 -rotate-30 rtl:-rotate-150" />
                  </div>
                </Link>
              </motion.div>
            </div>
