      ...
      <DropdownMenuTrigger asChild>
        {iconOnly ? (
          <Button
            variant="ghost"
            size="icon"
            className="text-foreground hover:bg-primary-100/30"
          >
          ...
          <Button
            variant="ghost"
            className="flex items-center gap-2 text-foreground hover:text-primary-700 hover:bg-primary-100/30 focus-visible:ring-primary-500"
          >
            <Globe className="h-5 w-5 text-foreground" />
