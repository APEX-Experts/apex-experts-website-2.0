                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:flex-wrap lg:gap-2 mt-4">
                  {keywords.map((keyword, index) => (
                    <div
                      ...
                      className="max-lg:w-full rounded-full border border-outline/30 hover:border-white flex flex-row justify-between px-4 py-2.5 lg:gap-2 items-center transition-colors"
                    >
