...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_hero_gallery" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "pages_blocks_hero_gallery" ADD CONSTRAINT "pages_blocks_hero_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_hero_gallery" ADD CONSTRAINT "pages_blocks_hero_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_hero"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_hero_gallery_order_idx" ON "pages_blocks_hero_gallery" USING btree ("_order");
  CREATE INDEX "pages_blocks_hero_gallery_parent_id_idx" ON "pages_blocks_hero_gallery" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_hero_gallery_image_idx" ON "pages_blocks_hero_gallery" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_hero_gallery" CASCADE;
