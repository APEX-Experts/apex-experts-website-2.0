...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_faq" ADD CONSTRAINT "pages_blocks_faq_cta_image_id_media_id_fk" FOREIGN KEY ("cta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_faq_cta_image_idx" ON "pages_blocks_faq" USING btree ("cta_image_id");
